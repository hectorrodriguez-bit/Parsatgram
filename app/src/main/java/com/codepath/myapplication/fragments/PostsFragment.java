...
import com.codepath.myapplication.PostsAdapter;
...
public class PostsFragment extends Fragment {
    ...
    protected SwipeRefreshLayout swipeContainer; //Added
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new PostsAdapter(getContext(), allPosts); //Step 3 from below
    ...
    protected void queryPosts() { //Takes posts we have and hands it over to the adapter
